        ...
        render(notif) {
            ...
            el.innerHTML = `
                ...
                <div style="flex:1;min-width:0">
                    ${notif.title ? `<div style="color:#e0e0e0;font-size:12px;font-weight:600;margin-bottom:2px">${notif.title}</div>` : ''}
                    <div style="color:#94a3b8;font-size:11px;line-height:1.4">${notif.message}</div>
                </div>
